...
public class TransactionService {
	 ...
	 * 
	 * @param elements array to be shifted to lower index
	 * @param shiftAmount the amount of shift
	 * @param intalizeValue the intalization  of free array elements
	 */
	 ...
	 * 
	 * @param elements  array of elements to get its statistics
	 * @param length number of elements starting from indx 0 that return its statistics. 
	 * @return Array of calculated values by the following order [sm,count,avg,max,min]
	 */
	public static BigDecimal[] getElementStatistics(BigDecimal[] elements,int length){
		...
		return new BigDecimal[] {sum,new BigDecimal(count),avg,max,min};
