...
public class TestJunit extends TestCase {
	...
	public void testArrayShift() {
		...
		BigDecimal[] elements = new BigDecimal[] { new BigDecimal(1), new BigDecimal(2), new BigDecimal(3),
				new BigDecimal(4), new BigDecimal(5), new BigDecimal(6), new BigDecimal(7), new BigDecimal(8),
				new BigDecimal(9), new BigDecimal(10), new BigDecimal(11) };
		int shiftamount = 3;
		BigDecimal[] target = new BigDecimal[] { new BigDecimal(4), new BigDecimal(5), new BigDecimal(6),
				new BigDecimal(7), new BigDecimal(8), new BigDecimal(9), new BigDecimal(10), new BigDecimal(11),
	...
	public void testArrayShift2() {
		...
		BigDecimal[] elements = new BigDecimal[] { new BigDecimal(1), new BigDecimal(2), new BigDecimal(3),
				...
				new BigDecimal(9), new BigDecimal(10), new BigDecimal(11) };
		int shiftamount = 20;
		BigDecimal[] target = new BigDecimal[] { new BigDecimal(0), new BigDecimal(0), new BigDecimal(0),
	...
	public void testArrayShift3() {
		...
		BigDecimal[] elements = new BigDecimal[] { new BigDecimal(1), new BigDecimal(2), new BigDecimal(3),
				...
				new BigDecimal(9), new BigDecimal(10), new BigDecimal(11) };
		int shiftamount = -10;
		BigDecimal[] target = new BigDecimal[] { new BigDecimal(1), new BigDecimal(2), new BigDecimal(3),
				new BigDecimal(4), new BigDecimal(5), new BigDecimal(6), new BigDecimal(7), new BigDecimal(8),
				new BigDecimal(9), new BigDecimal(10), new BigDecimal(11) };
	...
	public void testArayValuesStatistics() {
		...
		BigDecimal[] elements = new BigDecimal[] { new BigDecimal(3), new BigDecimal(8), new BigDecimal(-1),
				new BigDecimal(0), new BigDecimal(10), new BigDecimal(0), new BigDecimal(1), new BigDecimal(15),
				new BigDecimal(0), new BigDecimal(5), new BigDecimal(8) };

		BigDecimal tagetAvg = (new BigDecimal(49)).divide(new BigDecimal(8), 2, BigDecimal.ROUND_HALF_UP);

		BigDecimal[] target = new BigDecimal[] { new BigDecimal(49), new BigDecimal(8), tagetAvg, new BigDecimal(-1),
				new BigDecimal(15) };
		...
		target = new BigDecimal[] { new BigDecimal(10), new BigDecimal(3), tagetAvg, new BigDecimal(-1),
				new BigDecimal(8) };
